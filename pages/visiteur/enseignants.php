    ...
    <div class="container mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                ...
                <a href="/cours_en_ligne/pages/visiteur/catalogue.php?enseignant=john-doe" class="text-blue-500 hover:underline">Voir les cours</a>
            </div>
            <!-- Enseignant 2 -->
            <div class="bg-white rounded-lg shadow-lg p-6">
                <h2 class="text-xl font-bold mb-2">Jane Smith</h2>
                <p class="text-gray-600 mb-4">Experte en design UX/UI.</p>
                <a href="/cours_en_ligne/pages/visiteur/catalogue.php?enseignant=jane-smith" class="text-blue-500 hover:underline">Voir les cours</a>
            </div>
        </div>
    </div>
</main>
